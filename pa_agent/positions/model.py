...
class PositionState(BaseModel):
    ...
    trigger_gap_through: bool = False
    trigger_bar_seq: Optional[int] = None
    setup_provenance: Optional[dict] = None
    execution_eligible: bool = False
    expiry_bars: Optional[int] = None
    expiry_at_ms: Optional[int] = None
    last_observed_bar_ts: Optional[int] = None
    observed_closed_bars: int = 0
